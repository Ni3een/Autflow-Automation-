        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Use this webhook URL to connect your Stripe account to this workflow. Whenever a Stripe event occurs, the workflow will be triggered and you can use the event data in your workflow.
                    </DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                    ...
                    <div className="rounded-lg bg-muted p-4 space-y-2">
                        ...
                        <ul className="text-sm text-muted-foreground space-y-1">
                            ...
                            <li>
                                <code className="bg-background px-1 py-0.5 rounded">{"{{stripe.customer_id}}}"}</code>
                                 - Customer ID
                            </li>
                             <li>
