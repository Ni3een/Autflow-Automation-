...
import { useCreateCredentials, useUpdateCredentials } from "../hooks/use-credentials";
        ...
        <>
            ...
            <Card className="shadow-none">
                <CardHeader>
                    ...
                    <CardDescription>
                        {isEdit ? "Update your credential information." : "Add your API key to connect with our services."}
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                {credentialTypesOption.map((option) => (
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="sk-xxx" {...field} type="password" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <div className="flex gap-4">
                                ...
                                type="submit"
                                disabled={
                                    createCredentials.isPending || updateCredentials.isPending
                                }
                                >
